...
package local_project.talend_app_poc_2_0;
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_FnvOsAoMEeu2hukYDDQcbA", "2.0");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_FnvOsAoMEeu2hukYDDQcbA", "2.0");
 ...
 */
	...
	currentComponent="Implicit_Context_Database";
		...
		int tos_count_Implicit_Context_Database = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_Implicit_Context_Database{
                    ...
                    log4jParamters_Implicit_Context_Database.append("Parameters:");
                            log4jParamters_Implicit_Context_Database.append("DB_VERSION" + " = " + "MYSQL_8");
                        ...
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("HOST" + " = " + "\"mysql-svc.data-app-poc.svc.cluster.local\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("PORT" + " = " + "\"3306\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("DBNAME" + " = " + "\"datapoc\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("USER" + " = " + "\"root\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:VM6n5sFdnMhFYT6VLGUdQHeDPdkrP8dIIYOAzV7VgrTU0usucm/UP73anA==").substring(0, 4) + "...");     
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("TABLE" + " = " + "\"\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("QUERY" + " = " + "\"SELECT    `_MyTable_`.`key`,    `_MyTable_`.`value` FROM `_MyTable_`\"");
                        log4jParamters_Implicit_Context_Database.append(" | ");
                        ...
                        log4jParamters_Implicit_Context_Database.append(" | ");
                            log4jParamters_Implicit_Context_Database.append("ENABLE_STREAM" + " = " + "false");
                        log4jParamters_Implicit_Context_Database.append(" | ");
		    ...
		    java.util.Calendar calendar_Implicit_Context_Database = java.util.Calendar.getInstance();
		    calendar_Implicit_Context_Database.set(0, 0, 0, 0, 0, 0);
		    java.util.Date year0_Implicit_Context_Database = calendar_Implicit_Context_Database.getTime();
		    int nb_line_Implicit_Context_Database = 0;
		    java.sql.Connection conn_Implicit_Context_Database = null;
				String driverClass_Implicit_Context_Database = "com.mysql.cj.jdbc.Driver";
			    java.lang.Class jdbcclazz_Implicit_Context_Database = java.lang.Class.forName(driverClass_Implicit_Context_Database);
				String dbUser_Implicit_Context_Database = "root";
				
				 
	final String decryptedPassword_Implicit_Context_Database = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tahP0pmg60VD6TIqC3/CIFD3GaFQdOStu0+ksYUigEq2Jso6tBbhK/WTtg==");
				
				String dbPwd_Implicit_Context_Database = decryptedPassword_Implicit_Context_Database;
				
				String url_Implicit_Context_Database = "jdbc:mysql://" + "mysql-svc.data-app-poc.svc.cluster.local" + ":" + "3306" + "/" + "datapoc";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:CxCU4hSJdz5T0xBAGafb0brEQY7nHzNjPb7x5gUHCXrGLIkRyzxjdrr4Ng==").substring(0, 4) + "...");     
                        log4jParamters_tDBOutput_1.append(" | ");
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tcI8khjReaSt8FlGbaP8QrLrpU6ItkYaX12bDwjbxL4j4G4xvcirVWMAXw==");
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "" + "` (`txn_msg_id`,`brwr_class_type_nm`,`brwr_id`,`first_nm`,`lst_nm`,`mid_nm`,`sfx_nm`,`brth_dt`,`cr_rpt_auth_ind`,`depnt_ct`,`marr_stat_type_nm`,`cr_score_num`,`citzn_resd_type_nm`,`gndr_type_nm`,`resd_addr_line_txt`,`mail_addr_line_txt`,`mail_city_nm`,`mail_pstl_cd`,`mail_st_cd`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
} else {pstmt_tDBOutput_1.setString(2, brwr.brwr_class_type_nm);
}

                            if(brwr.brwr_id == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, brwr.brwr_id);
}

                            if(brwr.first_nm == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, brwr.first_nm);
}

                            if(brwr.lst_nm == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, brwr.lst_nm);
}

                            if(brwr.mid_nm == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, brwr.mid_nm);
}

                            if(brwr.sfx_nm == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, brwr.sfx_nm);
}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = talend_app_poc.class.getClassLoader().getResourceAsStream("local_project/talend_app_poc_2_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     261619 characters generated by Talend Open Studio for Big Data 
 *     on the 30 November 2020 at 2:33:48 PM IST
 ************************************************************************************************/